///scr_drawPauseBorderAndControles(Select D-Pad or None, Words, A T/F, A words, B T/F, B words, Menu Name);       
...
if (argument6 != "") {
    ...
    draw_rectangle(0, 0, string_height(argument6)*4.5, string_height(argument6) + (pauseBorderControlesSpace*2), false);
}
draw_set_color(c_menuBlack);
draw_set_valign(fa_top);
draw_set_halign(fa_center);
draw_text(string_height(argument6)*2.1, pauseBorderControlesSpace, argument6);
